package com.example.holyquran.ui.createPassword
...
class CreatePasswordFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        mSetPasswordBinding.clear.setOnClickListener {
            clear()
        }
        ...
        mSetPasswordBinding.submit.text = sharedPreference.getString("password", "")
    ...
    private fun clear() {
        ...
        val sharedPreference =
            requireActivity().getSharedPreferences(passKey, Context.MODE_PRIVATE)
        val sharedPreferencePasswordStatus =
            requireActivity().getSharedPreferences(passStatus, Context.MODE_PRIVATE)
        sharedPreference.edit().clear().apply()
        sharedPreferencePasswordStatus.edit().clear().apply()
    }
